...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function()
    ...
    nnoremap('lfd', '<cmd>lua vim.lsp.buf.format({async = true})<cr>')
    nnoremap('lca', '<cmd>lua vim.lsp.buf.code_action()<cr>')
    xnoremap('lca', '<cmd>lua vim.lsp.buf.range_code_action()<cr>')
