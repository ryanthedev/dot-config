...
_G.packer_plugins = {
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["neotest-dotnet"] = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/neotest-dotnet",
